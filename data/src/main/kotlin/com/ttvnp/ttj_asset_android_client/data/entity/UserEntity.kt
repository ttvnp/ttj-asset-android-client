...
class UserEntity(
        ...
        @Column(defaultExpr = "")
        @Setter("cellphoneNumberNationalCode")
        var cellphoneNumberNationalCode: String = "",

        @Column(defaultExpr = "")
        @Setter("cellphoneNumber")
        var cellphoneNumber: String = "",

        @Column(defaultExpr = "")
        @Setter("idDocument1ImageURL")
        var idDocument1ImageURL: String = "",

        @Column(defaultExpr = "")
        @Setter("idDocument2ImageURL")
        ...
        @Column(defaultExpr = "0")
        @Setter("identificationStatus")
        var identificationStatus: Int = 0,

        @Column(defaultExpr = "false")
        @Setter("grantEmailNotification")
        var grantEmailNotification: Boolean = false,

        @Column(defaultExpr = "false")
        @Setter("requirePasswordOnSend")
